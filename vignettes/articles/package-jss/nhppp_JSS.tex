...
\begin{tabular}{rlllll}
 ...
 & Thinning $\lambda_*$=$\lambda_{*a}$ & Thinning $\lambda_*$=$\lambda_{*b}$ & Thinning $\lambda_*$=$\lambda_{*c}$ & Inversion & Order statistics \\ 
  \hline
Sample mean & 171.235 & 171.106 & 171.111 & 171.029 & 171.035 \\ 
  $B_\mu$ & 0.100 & -0.029 & -0.023 & -0.106 & -0.099 \\ 
  $B_{\mu, rel}$ & 0.059 & -0.017 & -0.014 & -0.062 & -0.058 \\ 
  Sample variance & 168.577 & 172.552 & 172.727 & 166.766 & 172.207 \\ 
  $B_V$ & -2.558 & 1.417 & 1.593 & -4.368 & 1.073 \\ 
  $B_{V, rel}$ & -1.495 & 0.828 & 0.931 & -2.553 & 0.627 \\ 
  Goodness of fit, $\chi^2$ [$p$~value] & 0.206 [1.000] & 0.059 [1.000] & 0.253 [1.000] & 0.084 [1.000] & 0.235 [1.000] \\ 
  $W_1$ [$p$~value] & 0.167 [1.000] & 0.087 [1.000] & 0.104 [1.000] & 0.192 [1.000] & 0.167 [1.000] \\ 
  Equal tail 95\% CI = [146, 197] & [146, 197] & [146, 197] & [146, 197] & [146, 197] & [146, 197] \\ 
  Equal tail 90\% CI = [150, 193] & [150, 193] & [150, 193] & [149, 193] & [150, 193] & [150, 193] \\ 
  Equal tail 75\% CI = [156, 186] & [156, 186] & [156, 186] & [156, 186] & [156, 186] & [156, 186] \\ 
...
\begin{tabular}{rll}
 ...
 & Goodness of fit, $\chi^2$ [$p$~value] & $W_1$ [$p$~value] \\ 
  \hline
Thinning $\lambda_*$=$\lambda_{*a}$ & 0.004 [1.000] & 0.360 [1.000] \\ 
  Thinning $\lambda_*$=$\lambda_{*b}$ & 0.004 [1.000] & 0.373 [1.000] \\ 
  Thinning $\lambda_*$=$\lambda_{*c}$ & 0.004 [1.000] & 0.380 [1.000] \\ 
  Inversion & 0.004 [1.000] & 0.361 [1.000] \\ 
  Order statistics & 0.004 [1.000] & 0.359 [1.000] \\ 
   \hline
\end{tabular}
}
...
\pkg{reda} thinning ($\lambda_*$=$\lambda_{*a}$) & 0.010 [1.000] & 0.279 [1.000] \\ 
  ...
  \pkg{simEd} thinning ($\lambda_*$=$\lambda_{*a}$) & 0.054 [1.000] & 0.520 [0.954] \\ 
  \pkg{IndTestPP} thinning (no $\lambda_*$) & 0.391 [1.000] & 2.288 [0.961] \\ 
  \pkg{IndTestPP} inversion & 0.515 [1.000] & 2.136 [0.984] \\ 
   \hline
\end{tabular}
}
