...
\end{alltt}
\begin{verbatim}
## [1] 0.6915438 2.4806410 3.0176305 4.5046973 5.1085566 7.1457364
## [7] 7.5804602
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{tabular}{rlllll}
 ...
 & Thinning $\lambda_*$=$\lambda_{*a}$ & Thinning $\lambda_*$=$\lambda_{*b}$ & Thinning $\lambda_*$=$\lambda_{*c}$ & Inversion & Order statistics \\ 
  \hline
Sample mean & 172.040 & 170.170 & 172.800 & 169.800 & 171.630 \\ 
  $B_\mu$ & 0.905 & -0.965 & 1.665 & -1.335 & 0.495 \\ 
  $B_{\mu, rel}$ & 0.529 & -0.564 & 0.973 & -0.780 & 0.289 \\ 
  Sample variance & 174.705 & 183.516 & 187.051 & 147.293 & 168.781 \\ 
  $B_V$ & 3.571 & 12.382 & 15.916 & -23.842 & -2.354 \\ 
  $B_{V, rel}$ & 2.087 & 7.235 & 9.300 & -13.932 & -1.375 \\ 
  Goodness of fit, $\chi^2$ [$p$~value] & 5.281 [1.000] & 4.166 [1.000] & 5.613 [1.000] & 6.044 [1.000] & 4.835 [1.000] \\ 
  $W_1$ [$p$~value] & 1.509 [0.138] & 1.137 [0.078] & 1.834 [0.056] & 1.682 [0.092] & 1.075 [0.176] \\ 
  Equal tail 95\% CI = [146, 197] & [145, 196] & [147, 196] & [146, 199] & [147, 195] & [150, 194] \\ 
  Equal tail 90\% CI = [150, 193] & [148, 193] & [147, 194] & [150, 197] & [149, 189] & [150, 190] \\ 
  Equal tail 75\% CI = [156, 186] & [155, 186] & [153, 185] & [158, 188] & [156, 182] & [156, 187] \\ 
  Equal tail 50\% CI = [162, 180] & [164, 182] & [162, 179] & [163, 181] & [162, 178] & [162, 181] \\ 
   \hline
\end{tabular}
}
...
\begin{tabular}{rll}
 ...
 & Goodness of fit, $\chi^2$ [$p$~value] & $W_1$ [$p$~value] \\ 
  \hline
Thinning $\lambda_*$=$\lambda_{*a}$ & 0.009 [1.000] & 0.489 [0.992] \\ 
  Thinning $\lambda_*$=$\lambda_{*b}$ & 0.008 [1.000] & 0.323 [0.998] \\ 
  Thinning $\lambda_*$=$\lambda_{*c}$ & 0.009 [1.000] & 0.262 [1.000] \\ 
  Inversion & 0.012 [1.000] & 0.640 [0.978] \\ 
  Order statistics & 0.009 [1.000] & 0.408 [0.992] \\ 
   \hline
\end{tabular}
}
