...
#> Method 2 (vectorized, thinning): 0.113 sec elapsed
```
...
1.  Method 1 (nonvectorized): 1.563 sec elapsed. This is the slowest
    approach – but still not bad for $10^{5}$ samples!

2.  Method 2 (vectorized, thinning): 0.113 sec elapsed. This approach is
