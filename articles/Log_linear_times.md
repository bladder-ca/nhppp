...
tictoc::toc(log = TRUE)
#> Method 1 (nonvectorized): 1.495 sec elapsed
...
#> Method 2 (vectorized, thinning): 0.115 sec elapsed
```
...
tictoc::toc(log = TRUE) # timer end
#> Method 3 (inversion): 0.017 sec elapsed
```
...
1.  Method 1 (nonvectorized): 1.495 sec elapsed. This is the slowest
    approach – but still not bad for $10^{5}$ samples!

2.  Method 2 (vectorized, thinning): 0.115 sec elapsed. This approach is
...
3.  Method 3 (inversion): 0.017 sec elapsed. This approach is many times
